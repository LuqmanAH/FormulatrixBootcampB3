...
public class TreasureBox
{
    ...
    ~TreasureBox()
    {
        Console.WriteLine($"Treasure {_TreasureBoxID} has been looted");
    }
}
...
public class Program
{
    public static void Main()
    {
        ...
        GC.Collect();
        GC.WaitForPendingFinalizers(); // * Ensure every finalizer or destructor successfully removed instances
        stopwatch.Stop();
